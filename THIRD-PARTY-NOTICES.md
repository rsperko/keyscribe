...
KeyScribe is licensed under the GNU General Public License v3.0 (see `LICENSE`). It
incorporates the third-party software libraries below, and downloads the speech-recognition
model weights below at runtime. Each remains under its own license.

## Bundled software libraries

| Component | Project | License |
|---|---|---|
| FluidAudio (Parakeet engine) | github.com/FluidInference/FluidAudio (KeyScribe fork) | Apache-2.0 |
...
| moonshine-swift (Moonshine engine) | github.com/moonshine-ai/moonshine-swift | MIT |
| ONNX Runtime (bundled in Moonshine.xcframework) | github.com/microsoft/onnxruntime | MIT |
...
## Speech-recognition model weights (downloaded at runtime)
...
> separate non-commercial Moonshine Community License. KeyScribe ships only the English model.

Full license texts are available in each project's repository and, for bundled libraries, in the
resolved package checkouts.
